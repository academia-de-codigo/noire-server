...
const Login = require(Path.join(process.cwd(), 'lib/modules/authorization/routes/api/login'));
const Profile = require(Path.join(process.cwd(), 'lib/modules/authorization/routes/api/profile'));
const User = require(Path.join(process.cwd(), 'lib/modules/authorization/routes/api/user'));
const Role = require(Path.join(process.cwd(), 'lib/modules/authorization/routes/api/role'));
...
exports.endpoints = [
    ...
    { method: 'GET', path: '/renew', config: Login.renew },
