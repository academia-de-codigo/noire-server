// private file containing environment variables
exports.env = '.env';
...
exports.pagination = {
    include: ['/api/role', '/api/user', '/api/contacts']
    // include: ['*'],
    // exclude: []
};
...
// noire server email template settings
exports.mail = {
    ...
    url: {
        signup: 'https://localhost:8443/register',
        passwordReset: 'https://localhost:8443/password-update'
    }
};
