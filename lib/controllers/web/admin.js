...
var ResourceService = require('../../services/role');
...
internals.getMain = function(request, reply) {
    ...
    Promise.join(getUserCount, getRoleCount, getResourceCount, function(userCount, roleCount, resourceCount) {
        ...
        return reply.view('pages/admin', {
            getAdminPartial: internals.getPartialHelper(request.query.p),
...
exports.get = function(request, reply) {
    ...
    var handler = internals.handlers[request.query.p] || internals.handlers.main;
