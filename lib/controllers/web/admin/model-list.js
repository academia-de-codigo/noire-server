...
exports.getNextPageHelper = function(query, count) {
    ...
    return function() {
        ...
        console.log('the next page query', query);
        return internals.buildQuery(query);
    };
};

exports.getPreviousPageHelper = function(query, count) {
    var page = count > 0 ? query.page || 1 : 0;
    return function() {
        if (page > 1) {
            query.page = parseInt(page) - 1;
        }
...
exports.getFirstPageHelper = function(query, count) {
    return function() {
        query.page = count > 0 ? 1 : 0;
        return internals.buildQuery(query);
    };
};
...
exports.getLastPageHelper = function(query, count) {
    ...
    return function() {
        ...
        console.log('the last page query', query);
        return internals.buildQuery(query);
    };
};
