...
exports.list = function(request, reply) {
    ...
    RoleService.list(request.query).then(function(roles) {
...
exports.delete = function(request, reply) {
    ...
    RoleService.delete(request.params.id).then(function() {
        ...
        console.log('controller delete', error.stack);
        reply(HSError.toBoom(error));
    });
};
...
exports.addUsers = function(request, reply) {

    request.log(['role', 'addUser', 'debug']);

    RoleService.addUsers(request.params.id, request.payload.id).then(function(data) {
...
exports.removeUsers = function(request, reply) {

    request.log(['role', 'removeUser', 'debug']);

    RoleService.removeUsers(request.params.id, request.payload.id).then(function() {
...
exports.removePermissions = function(request, reply) {

    request.log(['role', 'removePermission', 'debug']);

    RoleService.removePermissions(request.params.id, request.payload.id).then(function() {
