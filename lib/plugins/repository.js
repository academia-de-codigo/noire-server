...
internals.buildCriteria = function buildCriteria(Model, searchOptions) {
    ...
    searchOptions = {
        limit: searchOptions.limit || Model.LIMIT_DEFAULT || internals.LIMIT_DEFAULT,
...
internals.createRepository = function(Model) {
    ...
    return {
        ...
        findAll: function(searchOptions) {
            ...
            var criteria = internals.buildCriteria(Model, searchOptions);
