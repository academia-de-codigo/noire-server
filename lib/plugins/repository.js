...
/* limit default for rows returned when using findAll if
...
internals.createRepository = function(Model) {
    ...
    return {
        ...
        findAll: function(criteria) {
            ...
            criteria = buildCriteria(Model.LIMIT_DEFAULT, criteria);
            return Model.query()
...
function buildCriteria(ModelLimit, searchOptions) {
    ...
    searchOptions = {
        limit: searchOptions.limit || ModelLimit || LIMIT_DEFAULT,
