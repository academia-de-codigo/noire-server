...
exports.register = function(server, options, next) {
    ...
    web.ext('onRequest', function(request, reply) {
        ...
        if (request.url.path === '/') {
            return reply.redirect(Url.format(internals.webUrl) + Config.prefixes.home).permanent();
        }
    ...
    webTls.ext('onRequest', function(request, reply) {
        ...
        if (request.url.path === '/') {
            return reply.redirect(Url.format(internals.webTlsUrl) + Config.prefixes.home).permanent();
        }
