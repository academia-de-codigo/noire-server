...
exports.redirect = {
    ...
    tlsOnly: [exports.prefixes.admin, exports.prefixes.profile]
};

exports.views = require('./views'); // HACK? no circular deps are created if only required after exports.cache
