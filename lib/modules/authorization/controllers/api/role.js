 ...
 */
exports.removeUsers = function(request) {
    // path params are passed as strings
    const [id, userIds] = [Number.parseInt(request.params.id), request.payload.id];

    return RoleService.removeUsers(id, userIds);
};
 ...
 */
exports.addPermissions = function(request) {
    // path params are passed as strings
 ...
 */
exports.removePermissions = function(request) {
    // path params are passed as strings
    const [id, permIds] = [Number.parseInt(request.params.id), request.payload.id];

    return RoleService.removePermissions(id, permIds);
};
