...
describe('Model: permission', () => {
    ...
    it('should contain has-one relation mappings to resource model', () => {
        ...
        expect(PermissionModel.relationMappings.resource.relation).to.equals(BaseModel.HasOneRelation);
    });
    ...
    it('should contain many-to-many relation mappings to role model', () => {
        ...
        expect(PermissionModel.relationMappings.roles.relation).to.equals(BaseModel.ManyToManyRelation);
    });
});
